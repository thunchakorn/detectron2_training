...
from train_util import do_evaluate, compare_gt, setup, regist_dataset
...
def main(args):
    test_name, num_class = regist_dataset(args.directory, args.thing_classes)
    ...
    compare_gt(cfg, dir = args.directory,
